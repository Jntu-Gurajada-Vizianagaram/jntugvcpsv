          ...
          <div className="portal-board">
            <div className="profile-detail-grid">
              ...
              <div className="profile-info-content">
                ...
                <article
                  className="content-card-block card-institutional"
                  style={{ marginTop: "3rem" }}
                >
                  <h3>Institutional Responsibility</h3>
                  <p>
                    As a member of the {profile.department} at JNTU-GV College of Pharmaceutical
                    Sciences, {profile.name} is dedicated to maintaining high academic records and fostering
                    a research-centric environment for all pharmacy aspirants.
                  </p>
                </article>
              </div>
            </div>
